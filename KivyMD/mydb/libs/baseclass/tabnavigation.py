...
class MyNavigationItem(ThemableBehavior, ButtonBehavior, BoxLayout):
...
class MyNavigationBar(ThemableBehavior, BoxLayout):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
    ...
    def add_widget(self, widget, index=0, canvas=None):
        if issubclass(widget.__class__, MyNavigationItem):
